    ...
    <div className="login-main">
      <div className="login-container">
        ...
        <div className="right">
          ...
          <form onSubmit={handleSubmit} className="right-inputs">
