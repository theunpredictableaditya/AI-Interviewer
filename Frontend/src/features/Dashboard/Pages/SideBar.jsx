  ...
  return (
    <div className='sidebar'>
      ...
      <div className="sidebar-activity">
        <div className={`home ${location.pathname === "/dashboard/home" ? "active" : ""}`} onClick={() => {navigate("/dashboard/home")}}>
...
<path d="M2 16C1.45 16 0.979167 15.8042 0.5875 15.4125C0.195833 15.0208 0 14.55 0 14V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H14C14.55 0 15.0208 0.195833 15.4125 0.5875C15.8042 0.979167 16 1.45 16 2V6.5L20 2.5V13.5L16 9.5V14C16 14.55 15.8042 15.0208 15.4125 15.4125C15.0208 15.8042 14.55 16 14 16H2ZM2 14H14V2H2V14Z" fill="#94A3B8"/>
      ...
      <div className="bottom">
        <div className="profile">
          <img src="" alt="Pic" />
          <div className="info">
                      <div className="name">Alex Rivora</div>
          <div className="job-profile">Software Engineer</div>
          </div>
        </div>
        <div className="logout" onClick={handleLogOut}>
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M2 18C1.45 18 0.979167 17.8042 0.5875 17.4125C0.195833 17.0208 0 16.55 0 16V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H9V2H2V16H9V18H2ZM13 14L11.625 12.55L14.175 10H6V8H14.175L11.625 5.45L13 4L18 9L13 14Z" fill="#94A3B8"/>
</svg>
          <span>LOGOUT</span>
        </div>
      </div>
